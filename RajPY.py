...
import hashlib
import webbrowser  # ✅ Add this to open HTML file in browser

# Stored credentials (hashed password)
STORED_USERNAME = "Sameer"
STORED_PASSWORD_HASH = hashlib.sha256("SMK@123".encode()).hexdigest()

# ✅ Path to your HTML file (change this to your actual path)
HTML_FILE_PATH = "Raj.html"  # 🔁 Change this path
...
def check_login():
    ...
    if entered_username == STORED_USERNAME and entered_password_hash == STORED_PASSWORD_HASH:
        ...
        webbrowser.open(HTML_FILE_PATH)  # ✅ Open the HTML file in browser
    else:
